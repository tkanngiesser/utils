...
def connect_to_spo(spo_cfg):
    spo_credentials = ClientCredential(spo_cfg['client_id'], spo_cfg['client_secret'])
    spo_cxn = ClientContext(spo_cfg['url']).with_credentials(spo_credentials)
    return spo_cxn
